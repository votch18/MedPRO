                            ...
                            <aside class="menu-sidebar3 js-spe-sidebar">
                                <nav class="navbar-sidebar2 navbar-sidebar3">
                                    <ul class="list-unstyled navbar__list" style="border-top: 5px solid #4272d7;">
                                        ...
                                        <li class="<?=App::getRouter()->getController() == 'members' && App::getRouter()->getAction() == 'suppliers' ? 'active' : '' ?>">
                                            <a href="/admin/members/suppliers/">
                                                <i class="fa fa-truck"></i>Suppliers
                                            </a>
                                        </li>
                                        <li class="<?=App::getRouter()->getController() == 'members' && App::getRouter()->getAction() == 'buyers' ? 'active' : '' ?>">
                                            <a href="/admin/members/buyers/">
                                                <i class="fas fa-shopping-basket"></i>Buyers
                                            </a>
                                        </li>
                            ...
                            <div class="page-content">
                                ...
                                <div class="row">                               
                                    <div class="col-md-12  p-t-50">
                                        <div class="copyright">
                                            <p>Copyright © 2018 MedPro. All rights reserved. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
