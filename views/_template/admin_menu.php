<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="/admin/"><?=Setting::get('site_name')?></a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Funds">
                <a class="nav-link" href="/admin/funds/">
                    <i class="fa fa-fw fa-area-chart"></i>
                    <span class="nav-link-text">Funds</span>
                </a>
            </li>
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Expenses">
                <a class="nav-link" href="/admin/expenses/">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Members">
                ...
                <ul class="sidenav-second-level collapse" id="collapseMulti">
                    <li>
                        <a href="/admin/members/">View Members</a>
                    </li>
                    <li>
                        <a href="/admin/members/new/">Add Member</a>
                    </li>
                    <li>
                        <a href="/admin/members/print_all/">Print All Members</a>
                    </li>
                    <li>
                        <a href="/admin/members/deleted/">Deleted Members</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Settings">
                ...
                <ul class="sidenav-second-level collapse" id="collapseSettings">
                    ...
                    <li>
                        <a href="/admin/users/change_password/"><i class="fa fa-user"></i> Change Password</a>
                    </li>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <form method="POST" action="/admin/loans/search/"  class="form-inline my-2 my-lg-0 mr-lg-2" >
