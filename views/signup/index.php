				...
				<div class="col-md-6 p-b-30">
					...
					<?php } ?>
						...
						<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="company" placeholder="Company" required>
						</div>
						...
						<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="password" name="confirm" placeholder="Confirm password" required>
						</div>

						<div class="size15 m-b-20">
							<input type="checkbox" name="supplier" >
							Are you a medicine supplier?
						</div>
